...
#ifndef METAHEURISTICS_FENWICK_TREE_H
#define METAHEURISTICS_FENWICK_TREE_H
...
private:
    ...
    {
        const auto offset = CHAR_BIT * sizeof(Size) - count_left_zeros(size() - 1);
...
#endif //METAHEURISTICS_FENWICK_TREE_H
